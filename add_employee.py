...
class AplicacaoGerenciamentoFuncionarios:
    def __init__(self, root):
        ...
        # Rótulos e Campos de Entrada para as Informações Pessoais
        ...
        # ... (Outros campos de informações pessoais omitidos para economizar espaço)
        ...
        # Rótulos e Campos de Entrada para as Informações Profissionais
        ...
        # ... (Outros campos de informações profissionais omitidos)

        # Seção de Endereço e Aluguéis
        ...
        # Rótulos e Campos de Entrada para Endereço
        ...
        # Rótulos e Opções para Aluguel de Carro
        ...
        self.var_aluguel_carro.set("Não")  # Valor padrão "Não"
        ...
        # Rótulos e Opções para Aluguel de Notebook
        ...
        self.var_aluguel_notebook.set("Não")  # Valor padrão "Não"
        ...
        # Rótulos e Opções para Aluguel de Celular
        ...
        self.var_aluguel_celular.set("Não")  # Valor padrão "Não"
        ...
        # ... (Campos de aluguel de notebook e celular omitidos para economizar espaço)
        ...
        # Tabela de Exibição de Funcionários
        self.lista_funcionarios = ttk.Treeview(root, columns=("Nome", "Data de Nascimento", "E-mail", "Telefone", "Cargo", "Departamento", "Salário por Hora", "Data de Contratação", "Supervisor", "Anos de Experiência", "Endereço", "Aluguel de Carro", "Valor do Aluguel de Carro", "Aluguel de Notebook", "Valor do Aluguel de Notebook", "Aluguel de Celular", "Valor do Aluguel de Celular"))
        ...
        self.lista_funcionarios.heading("#4", text="Telefone")
        self.lista_funcionarios.heading("#5", text="Cargo")
        self.lista_funcionarios.heading("#6", text="Departamento")
        self.lista_funcionarios.heading("#7", text="Salário por Hora")
        self.lista_funcionarios.heading("#8", text="Data de Contratação")
        self.lista_funcionarios.heading("#9", text="Supervisor")
        self.lista_funcionarios.heading("#10", text="Anos de Experiência")
        self.lista_funcionarios.heading("#11", text="Endereço")
        self.lista_funcionarios.heading("#12", text="Aluguel de Carro")
        self.lista_funcionarios.heading("#13", text="Valor do Aluguel de Carro")
        self.lista_funcionarios.heading("#14", text="Aluguel de Notebook")
        self.lista_funcionarios.heading("#15", text="Valor do Aluguel de Notebook")
        self.lista_funcionarios.heading("#16", text="Aluguel de Celular")
        self.lista_funcionarios.heading("#17", text="Valor do Aluguel de Celular")
    ...
    def adicionar_funcionario(self):
        ...
        data_contratacao = self.entrada_data_contratacao.get()
        supervisor = self.entrada_supervisor.get()
        ...
        # Validações
        if not nome or not data_nascimento or not email or not telefone or not cargo or not departamento or not salario_hora or not data_contratacao or not experiencia or not endereco:
        ...
        if not re.match(r'\d{2}/\d{2}/\d{4}', data_nascimento) or not re.match(r'\d{2}/\d{2}/\d{4}', data_contratacao):
            messagebox.showerror("Erro", "Formato de data inválido. Use DD/MM/AAAA.")
            return

        # Adicionar o funcionário à tabela de exibição
        self.lista_funcionarios.insert("", "end", values=(nome, data_nascimento, email, telefone, cargo, departamento, salario_hora, data_contratacao, supervisor, experiencia, endereco, aluguel_carro, valor_aluguel_carro, aluguel_notebook, valor_aluguel_notebook, aluguel_celular, valor_aluguel_celular))
    ...
    def baixar_relatorio_csv(self):
        funcionarios = self.lista_funcionarios.get_children()
        ...
        with open("relatorio_funcionarios.csv", "w", newline="") as csvfile:
            ...
            csvwriter.writerow(["Nome", "Data de Nascimento", "E-mail", "Telefone", "Cargo", "Departamento", "Salário por Hora", "Data de Contratação", "Supervisor", "Anos de Experiência", "Endereço", "Aluguel de Carro", "Valor do Aluguel de Carro", "Aluguel de Notebook", "Valor do Aluguel de Notebook", "Aluguel de Celular", "Valor do Aluguel de Celular"])

            for funcionario in funcionarios:
                dados = self.lista_funcionarios.item(funcionario, "values")
